<section class="advanced-search-wrapper vina-advanced-search-wrapper">
	<div class="container">
		<div class="advanced-search">
			<h2 class="section-title">TÌM GÓI CƯỚC THEO NHU CẦU</h2>
			<form action="<?php echo home_url('/'); ?>" class="advanced-search-form" method="get">
				...
				<input type="hidden" name="mno" value="vinaphone">
			</form>
		</div>
	</div>
</section>
